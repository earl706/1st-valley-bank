...
//   const [activeSubSubItemHover, setActiveSubSubItemHover] = useState("");
...
//   useEffect(() => {
//     console.log(activeSubSubItemHover);
//   }, [activeSubSubItemHover]);
...
//                       className={({ isActive }) =>
//                         isActive
//                           ? "flex flex-col items-center font-bold text-[0.5625rem] transition-all h-full"
//                           : "flex flex-col items-center font-bold text-[0.5625rem] transition-all h-full"
//                       }
//                       key={index}
//                     >
...
//                     {activeItemHover == navItem.path &&
//                     navItem.subItems.length > 0 ? (
//                       <div className="flex absolute w-[100vw] left-0 bg-white text-black transition-all z-100 mt-[78px] text-[0.9rem]">
...
//                               to={subItem.path}
//                               key={index}
//                               className="flex w-full items-center gap-[10px] font-bold text-[#31542B]"
//                             >
//                               <div className="w-[25px] h-[25px] rounded-[5px] bg-[#31542B]"></div>
...
//                 <span className="text-[0.875rem] bg-white text-[#396131] font-bold rounded-[10px] py-[12px] px-[20px] cursor-pointer hover:text-white hover:bg-[#396131] hover:outline-1 outline-0 outline-white transition-all drop-shadow-lg">
//                   Contact Us
//                 </span>
//               </NavLink>
//             </div>
//           </div>
//           <div className="flex gap-[20px] py-[15px] px-[95px] text-[14px] font-bold font-[#1E1E1E] w-full drop-shadow-lg bg-white">
//             <ul className="flex gap-[30px]">
...
//                   onMouseEnter={() => setActiveItemHover(navItem.path)}
//                 >
//                   <NavLink to={navItem.path} className="" key={index}>
//                     {navItem.subItems.length > 0 ? (
//                       <div className="flex items-center gap-[5px]">
//                         {navItem.navItem}
//                         <FontAwesomeIcon
...
//                   {activeItemHover == navItem.path &&
//                   navItem.subItems.length > 0 ? (
//                     navItem.subItems[0].subsubItems.length > 0 ? (
//                       <div className="flex absolute w-[100vw] left-0 bg-white text-black transition-all z-100 mt-[16px] text-[0.9rem]">
//                         <div className="flex flex-col max-h-full bg-[#31542B] min-w-[250px] min-h-[200px]">
//                           {navItem.subItems.map((subItem, index) => (
//                             <button
//                               onMouseEnter={() =>
//                                 setActiveSubSubItemHover(subItem.path)
//                               }
//                               key={index}
//                               className="py-[10px] text-center w-full leading-[1.4rem] h-[50px] capitalize font-bold text-white cursor-pointer hover:bg-[#396131] hover:drop-shadow-lg"
//                             >
//                               {subItem.subItem}
//                             </button>
//                           ))}
//                         </div>
//                         <div className="grid grid-flow-col grid-rows-4 gap-y-[20px] gap-x-[100px] pl-[50px] pt-[10px] pb-[30px] leading-auto">
//                           {activeSubSubItemHover == navItem.subItems
//                             ? navItem.subItems.map((subItem, index) => (
//                                 <NavLink
//                                   onMouseEnter={() =>
//                                     setActiveSubItemHover(subItem.path)
...
//                     ) : (
//                       <div className="flex absolute w-[100vw] left-0 bg-white text-black transition-all z-100 mt-[16px] text-[0.9rem]">
//                         <div className="pl-[20px] pt-[20px] pr-[30px] max-h-full bg-[#31542B] min-w-[250px] min-h-[200px]">
//                           <span className="capitalize font-bold text-white">
//                             {navItem.navItem}
//                           </span>
//                         </div>
