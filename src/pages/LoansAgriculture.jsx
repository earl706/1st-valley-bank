		...
		<>
			<main className="flex flex-col gap-[40px] pb-[50px] lg:gap-[80px]">
				<section
					id="main"
					data-scroll
					className="mx-[5px] flex flex-col-reverse rounded-[8px] bg-white p-[20px] text-[#396131] drop-shadow-lg lg:mx-[10px] lg:flex-row lg:py-[50px]"
				>
					<div className="mx-[10px] flex flex-col gap-[20px] lg:w-2/3 lg:px-[60px] lg:py-[80px]">
						<span className="text-[2rem]/[2rem] font-bold lg:text-[4rem]/[4rem]">
							Loans / Agriculture
						</span>
						<span className="text-[0.8rem]/[1.6rem] lg:text-[1rem]/[2rem]">
							These loans are meant to boost agricultural productivity by providing sufficient funds
							that farmers need to finance their activities efficiently. Farmers can use the funds
							for multiple purposes such as to buy farm equipment, purchase agricultural supplies,
							cover land costs, make land improvements or repairs, cover operating costs, grow the
							business, market the products to the vendors and the public, or rebuild following a
							natural disaster or pandemic.
						</span>
					</div>
					<div className="flex items-center justify-center lg:w-1/3">
						<BarnIcon className="h-auto w-[60%]" />
					</div>
				</section>
				...
				<section
					id="story"
					className="mx-[20px] flex flex-col-reverse justify-between gap-[20px] text-[#396131] lg:mx-[60px] lg:flex-row"
				>
					<div className="flex flex-col gap-[20px] lg:w-3/5 lg:gap-[40px]">
						<div className="flex flex-col">
							<span className="text-[1rem]/[2srem] font-bold lg:text-[2rem]/[2rem]">
						...
						<div className="flex flex-col gap-[10px] lg:gap-[20px]">
							{[
								...
								<span className="text-[0.8rem]/[1.6rem] lg:text-[1rem]/[3rem]" key={index}>
									{paragraph}
								</span>
							))}
						</div>
					...
					<div className="flex items-center justify-center lg:w-2/5">
						<img src={img2} alt="" className="h-full rounded-[12px] object-cover lg:w-4/5" />
					</div>
				</section>
			</main>
		</>
